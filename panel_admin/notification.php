		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="forms.html"><i class="glyphicon glyphicon-tasks"></i> Pages</a></li>
                    <li class="submenu">
                         <a href="#">
        ...
        <div class="row">
		  ...
		  <!-- <div class="col-md-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text"   name="notificationdata" class="form-control" id="inputPassword3" placeholder="notificationdata">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="text"   name="timeing" class="form-control" id="inputPassword3" placeholder="Notification Timimg">
                    </div>
                  </div>
                  <div class="form-group">
                   <!-- <label for="inputPassword3" class="col-sm-2 control-label">StudentPassword</label> -->
                   <div class="col-sm-10">
                     <input type="text"   name="notiloc" class="form-control" id="inputPassword3" placeholder="Notification location">
                   </div>
                 </div>
                 ...
                 <div class="form-group">
                  <!-- <label for="inputPassword3" class="col-sm-2 control-label">StudentPassword</label> -->
                  <div class="col-sm-10">
                    <input type="text"   name="notidate" class="form-control" id="inputPassword3" placeholder="Notification date">
                  </div>
                </div
              ...
              if(isset($_POST['submit']))
               {
                                   ...
                                   $dssds=mysqli_real_escape_string($con,$_POST['notificationdata']);
                                 $bdsd=mysqli_real_escape_string($con,$_POST['timeing']);
                                   $bdsd1=mysqli_real_escape_string($con,$_POST['notiloc']);
                                     $dssds3=mysqli_real_escape_string($con,$_POST['notidate']);

                                     $uuid = uniqid('', true);

   $mmk="INSERT INTO notification (noti_id,noti_data,noti_timing,noti_location,noti_date)
                      values ('$uuid','$dssds','$bdsd','$bdsd1','$dssds3')";
   $hhby=mysqli_query($con,$mmk);

                 header("location:notification.php?yes=1");
                     ob_end_flush();
                   exit;
               }
